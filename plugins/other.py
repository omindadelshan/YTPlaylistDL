...
async def start_msg(client, message):
	await message.reply_text(
		f"👨‍💻 Hello ⚡ {message.from_user.mention}, I Am Powerfull Youtube Video dodownloader bot✳️. You Can Download Youtube Videos And Play Lists🤖.🎈Get A Help Send /help Command Or Click 🎲Help🎲 Button🤓.  This Bot Made By @omindas ❤️❤️..",
